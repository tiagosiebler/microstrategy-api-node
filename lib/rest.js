...
const BrowsingAPI = require('./restAPIs/browsing');
...
module.exports = class MicroStrategyRESTAPI extends RestConnection {
  constructor(...args) {
    ...
    // https://demo.microstrategy.com/MicroStrategyLibrary/api-docs/index.html#/Browsing
    this.browsing = new BrowsingAPI(this);
