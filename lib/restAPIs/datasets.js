...
module.exports = class RestTopic extends RestUtil {
   ...
   * @param {Object} tablesFormatting - object representation of table formatting
  ...
  uploadDataToUploadSession(datasetId, uploadSessionId, tableName, index, rawData, encodeAutomatically = true) {
    ...
    const dataAsString = typeof rawData == 'string' ? replacementData : JSON.stringify(replacementData);
