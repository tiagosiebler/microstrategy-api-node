...
module.exports = class RestTopic extends RestUtil {
   ...
   * @param {String} outputFlag - Filtered output. DEAFULT = include everything, FILTER_TOC = filter out cahpters and pages.
   * @param {String} fields
   */
   ...
   * Information about object to publish and recipient are detailed in object 'body'.
   ...
   * @param {String} projectId
   * @param {Strin} objectId
   * @param {String} userId
   */
  deleteUserObject(projectId, objectId, userId) {
